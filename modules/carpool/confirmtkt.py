...
async def confirmtkt(phone, client, out):
    name = "confirmtkt"
    domain = "securedapi.confirmtkt.com"
    ...
    try:
        ...
        if "false" in str(response_data).lower() or response_data.get("success") == True or response_data.get("msg") == "success":
            out.append({
                "name": name,
                "domain": domain,
